...
define(DRIFT_VERSION, '1.0.0');
define(DRIFT_PATH, 'system/modules/qwat-drift');
 ...
 */
$GLOBALS['TL_HOOKS']['outputBackendTemplate'][] = array('BackendDrift', 'loadJS');
$GLOBALS['TL_HOOKS']['outputFrontendTemplate'][] = array('FrontendDrift', 'loadJS');
